...
/**
 * Database Table for Keywords_urls in Referee URLs with Thumbnails
 *
 * For Table:-
 * <code>
 ...
 */
class refereeKeywords_urls extends refereeXoopsObject
{
    
    var $handler = 'refereeKeywords_urlsHandler';
...
/**
 * Handler Class for Keywords_urls
 * @author Simon Roberts (wishcraft@users.sourceforge.net)
 * @copyright copyright (c) 2015 labs.coop
 */
class refereeKeywords_urlsHandler extends refereeXoopsObjectHandler
{
    /**
     *
     * @var integer
     ...
     * @var string
     */
    var $child = 'refereeKeywords_urls';
