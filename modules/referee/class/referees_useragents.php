...
/**
 * Database Table for Referees_useragents in Referee URLs with Thumbnails
 *
 * For Table:-
 * <code>
 * CREATE TABLE `referee_referees_useragents` (
 *   `id` mediumint(128) NOT NULL,
 *   `referee_id` mediumint(16) NOT NULL DEFAULT '0',
 ...
 */
class refereeReferees_useragents extends refereeXoopsObject
{
    
    var $handler = 'refereeReferees_useragentsHandler';
    
    function __construct($id = null)
    {
        
        self::initVar('id', XOBJ_DTYPE_INT, null, false);
        self::initVar('referee_id', XOBJ_DTYPE_INT, null, false);
...
/**
 * Handler Class for Referees_useragents
 * @author Simon Roberts (wishcraft@users.sourceforge.net)
 * @copyright copyright (c) 2015 labs.coop
 */
class refereeReferees_useragentsHandler extends refereeXoopsObjectHandler
{
     ...
     * @var string
     */
    var $tbl = 'referee_referees_useragents';
     ...
     * @var string
     */
    var $child = 'refereeReferees_useragents';
