...
/**
 * Database Table for Urls_useragents in Referees URLs with Thumbnails
 *
 * For Table:-
 * <code>
 * CREATE TABLE `referee_urls_useragents` (
 *   `id` mediumint(128) NOT NULL,
 *   `url_id` mediumint(16) NOT NULL DEFAULT '0',
 ...
 */
class refereeUrls_useragents extends refereeXoopsObject
{
    
    var $handler = 'refereeUrls_useragentsHandler';
...
/**
 * Handler Class for Urls_useragents
 * @author Simon Roberts (wishcraft@users.sourceforge.net)
 * @copyright copyright (c) 2015 labs.coop
 */
class refereeUrls_useragentsHandler extends refereeXoopsObjectHandler
{
     ...
     * @var string
     */
    var $tbl = 'referee_urls_useragents';
     ...
     * @var string
     */
    var $child = 'refereeUrls_useragents';
